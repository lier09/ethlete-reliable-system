        ...
        <div className="p-6 overflow-y-auto space-y-6 text-sm text-slate-700 leading-relaxed">
          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-lg">
            ...
            <p className="text-xs text-amber-900 leading-normal">
              <strong>本系统提供测量误差基准与可检测变化阈值计算，不属于临床诊断或机理推断系统。</strong>
              当测试变化超过 MDC95 时，统计学上<strong>只能解释为：“该变化在 95% 置信度下超过了当前测试协议下的预期测量误差。”</strong>
              <br />
              超过MDC仅表示观察到的变化超过预期测量误差，不说明变化的生理或训练原因。不得直接定性为特定生理状态，必须由体能教练和运动科学家结合实际负荷数据（如 GPS 总跑动距离、RPE 主观评分）与专业检查综合研判。
            </p>
          </div>
